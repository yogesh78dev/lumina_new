export const PHONE_VALIDATION_MESSAGE = 'Enter a valid phone number using 7 to 15 digits. You may use a leading + and separators like spaces, hyphens, or brackets.';
